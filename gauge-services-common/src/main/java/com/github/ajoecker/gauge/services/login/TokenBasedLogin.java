...
import static com.github.ajoecker.gauge.services.ServiceUtil.seperator;
...
public final class TokenBasedLogin implements LoginHandler {
    ...
    public void loginWithCredentials(String user, String password, Connector connector) {
        loginToken = sendLoginQuery(connector, s -> replaceVariablesInQuery(s, "user:" + user + seperator() + "password:" + password, Optional.empty(), connector));
    }
