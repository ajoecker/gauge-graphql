...
public interface ConfigurationSource {
     ...
     * <code>gauge.service.seperator</code>. If this variable is not existing or empty, the default value is taken.
     * <p>
     * For example
     * <pre>
    ...
    default String seperator() {
        return orDefault("gauge.service.seperator", ",");
    }
     ...
     * <p>
     * The default value is <code>:</code> and is read in a Gauge project via the environment variable
     * <code>gauge.service.variable.seperator</code>. If this variable is not existing or empty, the default value is taken.
     * <p>
     * For example
     * <pre>
    ...
    default String variableSeperator() {
        return orDefault("gauge.service.variable.seperator", ":");
    }
