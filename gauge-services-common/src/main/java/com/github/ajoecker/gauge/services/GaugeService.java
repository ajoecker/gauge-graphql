...
public class GaugeService {
    ...
    public void sendingWithVariables(String query, Object variables) {
        if (variables instanceof String) {
            sending(replaceVariablesInQuery(query, (String) variables, previousResponse, connector));
        } else if (variables instanceof Table) {
            sending(replaceVariablesInQuery(query, (Table) variables, previousResponse, connector));
        } else {
